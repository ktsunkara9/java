...
public class BinarySearchDay3 {
    static int[] arr = {-22, -15, 1, 7, 20, 35, 55};
    public static void main(String[] args) {
        System.out.println(iterativeBinarySeach(arr, 1));
        System.out.println(iterativeBinarySeach(arr, 7));
        System.out.println(iterativeBinarySeach(arr, -22));
        System.out.println(iterativeBinarySeach(arr, 55));
        System.out.println(iterativeBinarySeach(arr, 99));
    ...
    public static int iterativeBinarySeach(int[] arr, int val) {
        int start = 0;
        int end = arr.length;
